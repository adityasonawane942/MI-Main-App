...
import com.example.miapp.data.Distance;
import com.example.miapp.data.Duration;
import com.example.miapp.data.Routes;
import com.example.miapp.data.UserLockBottomSheetBehavior;
...
public class tab1 extends Fragment implements OnMapReadyCallback, LocationListener, GoogleMap.OnCameraMoveListener, GoogleApiClient.ConnectionCallbacks,
...
//    private LatLng mapNoEntryLatLng2 = new LatLng(19.1274,72.914747);
    ...
    int x = 0;
    private static final String[] places = {"Convocation Hall", "LTPCSA"};
    LocationRequest mLocationRequest;
    GoogleApiClient mGoogleApiClient;
    Location mLastLocation;
    Marker mCurrLocationMarker;
    MarkerOptions goMarker;
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mapView = inflater.inflate(R.layout.tab1, container, false);
        ...
        gotoview = mapView.findViewById(R.id.gototext);
...
//                Toast.makeText(getContext(), "Clicked", Toast.LENGTH_LONG).show();
                ...
                builder.setItems(places, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(getContext(), "Position: " + which + " Value: " + places[which], Toast.LENGTH_LONG).show();
                        goMarker = new MarkerOptions().position(new LatLng(19.131973, 72.914285)).title(venueString).icon(BitmapDescriptorFactory.fromResource(R.drawable.placeholder)).anchor(half, half).zIndex(10);
                        mMap.addMarker(goMarker);

                        CameraPosition cameraPosition = new CameraPosition.Builder()
                                .target(new LatLng(19.131973, 72.914285))
                                .zoom(17)
                                .tilt(30)
                                .build();
...
//                    directionsAndLocationButton.getDrawable().setColorFilter(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.colorPrimaryDark), PorterDuff.Mode.SRC_IN);
...
//                            directionsAndLocationButton.getDrawable().setColorFilter(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.colorPrimary), PorterDuff.Mode.SRC_IN);
//                        }
//                    } else {
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                // If request is cancelled, the frag_result arrays are empty.
...
//        Toast.makeText(getContext(), "Moved", Toast.LENGTH_LONG).show();
//        Log.d("Here", mMap.getCameraPosition().zoom);
        if (mMap.getCameraPosition().zoom < 18.0){
            marker_size = 50;
            if (map_size){
                map_size = false;
                mMap.clear();
...
//        Log.d("Here", String.valueOf(mMap.getMinZoomLevel()));
...
//        mMap.addMarker(new MarkerOptions().position(mapNoEntryLatLng2).icon(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng3, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng4, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng5, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng6, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng7, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng8, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng9, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng10, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
...
//        mMap.addMarker(new MarkerOptions().position(mapNoEntryLatLng2).icon(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        ...
        mMap.addGroundOverlay(new GroundOverlayOptions().position(mapNoEntryLatLng10, marker_size).image(BitmapDescriptorFactory.fromResource(R.drawable.map_no_entry)).anchor(half, half));
        final float half = (float) 0.5;
        BitmapDrawable bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.blue_event_24);
        Bitmap b=bitmapdraw.getBitmap();
        Bitmap eventSmall = Bitmap.createScaledBitmap(b, marker_size, marker_size, false);
        bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.blue_food_24);
        b = bitmapdraw.getBitmap();
        Bitmap eatsmall = Bitmap.createScaledBitmap(b, marker_size, marker_size, false);
        bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.blue_bed_24);
        b = bitmapdraw.getBitmap();
        Bitmap accosmall = Bitmap.createScaledBitmap(b, marker_size, marker_size, false);
        bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.blue_toilet_24);
        b = bitmapdraw.getBitmap();
        Bitmap toiletsmall = Bitmap.createScaledBitmap(b, marker_size, marker_size, false);
        bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.blue_entry_24);
        b = bitmapdraw.getBitmap();
        Bitmap entrysmall = Bitmap.createScaledBitmap(b, marker_size, marker_size, false);

        for (Place place : eventList) {
            Marker marker = mMap.addMarker(
                    new MarkerOptions()
                            .position(place.getLatLng())
                            .icon(BitmapDescriptorFactory.fromBitmap(eventSmall))
                            .anchor(half, half));
            marker.setTag(place);
        }
        for (Place place : eateriesList) {
            Marker marker = mMap.addMarker(
                    new MarkerOptions()
                            .position(place.getLatLng())
                            .icon(BitmapDescriptorFactory.fromBitmap(eatsmall))
                            .anchor(half, half));
            marker.setTag(place);
        }
        for (Place place : accomodationList) {
            Marker marker = mMap.addMarker(
                    new MarkerOptions()
                            .position(place.getLatLng())
                            .icon(BitmapDescriptorFactory.fromBitmap(accosmall))
                            .anchor(half, half));
            marker.setTag(place);
        }
        for (Place place : toiletList) {
            Marker marker = mMap.addMarker(
                    new MarkerOptions()
                            .position(place.getLatLng())
                            .icon(BitmapDescriptorFactory.fromBitmap(toiletsmall))
                            .anchor(half, half));
            marker.setTag(place);
        }
        for (Place place : entryList) {
            Marker marker = mMap.addMarker(
                    new MarkerOptions()
                            .position(place.getLatLng())
                            .icon(BitmapDescriptorFactory.fromBitmap(entrysmall))
                            .anchor(half, half));
            marker.setTag(place);
        }
    }
